...
const ClubCard = ({ club, index }) => {
  return (
    ...
    >
      ...
      <div className="px-6 py-4 bg-gray-50 cursor-pointer">
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="w-full  bg-indigo-600 cursor-pointer hover:bg-indigo-700 text-white py-2 px-4 rounded-md transition-colors"
        >
          Learn More
        </motion.button>
      </div>
