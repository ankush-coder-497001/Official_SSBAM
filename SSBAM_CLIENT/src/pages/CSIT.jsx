...
import { FaArrowLeft, FaLaptopCode, FaUserGraduate, FaChalkboardTeacher, FaServer } from 'react-icons/fa';
...
const CSIT = () => {
  const courses = [
    {
      ...
      duration: '3 Years',
      seats: 60,
      description: 'Comprehensive program covering core computer science concepts and programming.',
    },
    {
      name: 'BCA',
      duration: '3 Years',
      seats: 60,
      description: 'Professional degree focusing on computer applications and software development.',
    },
    {
    ...
    },
    {
      ...
      duration: '1 Year',
      seats: 40,
      description: 'Post-graduate diploma in computer applications for career advancement.',
    },
  ];
  ...
  const facilities = [
    ...
    },
    {
      ...
      name: 'Server Room',
      description: 'Dedicated server infrastructure for practical learning and projects.',
    },
    {
      ...
      <section className="relative h-64 bg-indigo-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">Computer Science & Information Technology</h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our Computer Science and Information Technology department offers cutting-edge programs designed to prepare students for the rapidly evolving tech industry. We focus on both theoretical knowledge and practical skills.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our department is actively involved in research across various domains of computer science and information technology. Students have the opportunity to work on cutting-edge projects and collaborate with industry partners.
              </p>
              <ul className="list-disc pl-5 text-gray-600">
            ...
            >
              ...
              <p className="text-gray-600">
                For any queries regarding our CSIT programs, please contact our department office at <a href="mailto:csit@college.edu" className="text-indigo-600 hover:underline">csit@college.edu</a>.
              </p>
            </motion.div>
          </div>
        </div>
