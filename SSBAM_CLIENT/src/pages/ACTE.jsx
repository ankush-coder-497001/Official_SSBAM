          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                ...
                dedicated to promoting excellence in career and technical
                education. It provides resources, professional development, and
                advocacy for educators and institutions.
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-3xl font-bold text-indigo-800 mb-4 flex items-center gap-2">
                {" "}
                <RiMiniProgramLine className="text-indigo-800" />
                Programs
              </h2>
            ...
            >
              ...
              <p className="text-gray-600">
                For any queries regarding ACTE, please contact our career
                services office at{" "}
                <a
                  href="mailto:career@college.edu"
