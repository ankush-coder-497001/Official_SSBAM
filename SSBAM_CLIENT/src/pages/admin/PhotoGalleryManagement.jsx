  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-indigo-700">Photo Gallery Management</h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
      ...
      <select
        ...
        className="w-full px-4 py-2 rounded-lg border border-blue-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all cursor-pointer outline-none"
        required
      >
  ...
  <div className="mt-4">
    ...
    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-blue-400 rounded-lg hover:border-indigo-500 transition-colors">
      <div className="space-y-1 text-center">
        <div className="text-gray-500 font-medium">Upload a file</div>
  ...
  <div className="mt-6">
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-lg font-medium text-indigo-700 mb-4">Gallery Photos</h3>
