          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our Add-on Courses are designed to provide students with
                additional skills and knowledge beyond their regular curriculum.
                These courses are tailored to meet industry standards and
            ...
            >
              <h2 className="text-3xl font-bold text-indigo-800 mb-4 flex items-center gap-3">
                <FaClipboardList className="text-indigo-800 text-3xl" />{" "}
                Available Courses
              </h2>
            ...
            >
              ...
              <p className="text-gray-600">
                For any queries regarding add-on courses, please contact our
                course coordinator at{" "}
                <a
                  href="mailto:courses@college.edu"
