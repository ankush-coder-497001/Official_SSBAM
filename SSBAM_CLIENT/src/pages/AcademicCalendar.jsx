      ...
      <section className="relative h-64 bg-indigo-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">Academic Calendar</h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our Academic Calendar provides a comprehensive schedule of important dates and events throughout the academic year. It includes registration deadlines, exam schedules, and holidays.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                For any queries regarding the academic calendar, please contact our academic office at <a href="mailto:academic@college.edu" className="text-indigo-600 hover:underline">academic@college.edu</a>.
              </p>
            </motion.div>
          </div>
        </div>
