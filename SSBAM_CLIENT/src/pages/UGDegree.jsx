          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Our UG Degree programs offer a comprehensive education in
                various disciplines. These programs are designed to equip
                students with the knowledge and skills necessary for their
                future careers.
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-3xl font-bold text-indigo-800 mb-4 flex items-center gap-3">
                <FaRegFileAlt className="text-indigo-600 text-xl" /> Admission
                Requirements
              </h2>
              <p className="text-gray-700 leading-relaxed">
                To apply for our UG Degree programs, students must have
                completed their high school education with a minimum GPA of 3.0.
