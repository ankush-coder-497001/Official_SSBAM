        ...
        paymentSchedule: [
          {
            installment: "1st",
            amount: "₹15,500",
            dueDate: "At the time of admission",
          },
          {
            installment: "2nd",
            amount: "₹15,500",
            dueDate: "Before start of 2nd semester",
          },
        ],
      },
    },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-indigo-800 mb-6 flex items-center gap-2 ">
              <BsFileRuledFill className="text-indigo-800" />
              Available Courses
            </h2>
            <p className="text-gray-600 mb-8">
              Click on any course to view its detailed fee structure. Fees are
              subject to change as per college regulations.
            </p>
              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mt-2">
                    Total Fee: {course.fees.totalFee}
                  </p>
                </motion.div>
              ))}
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="p-4 border-b flex justify-between items-center">
              ...
              >
                <FaTimes className="w-6 h-6 text-indigo-800 cursor-pointer" />
              </button>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold">
                        {selectedCourse.fees.tuitionFee}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Examination Fee</p>
                      <p className="font-semibold">
                        {selectedCourse.fees.examinationFee}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Library Fee</p>
                      <p className="font-semibold">
                        {selectedCourse.fees.libraryFee}
                      </p>
                    </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    {selectedCourse.fees.paymentSchedule.map(
                      (schedule, index) => (
            ...
            <div className="p-4 border-t">
              <p className="text-sm text-gray-600">
                Note: All fees are subject to change as per college regulations.
                Additional charges may apply for specific programs or
                facilities.
              </p>
            </div>
          </motion.div>
