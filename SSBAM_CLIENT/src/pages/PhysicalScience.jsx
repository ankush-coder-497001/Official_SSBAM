      ...
      <section className="relative h-64 bg-indigo-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">Physical Science</h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our Physical Science department offers a comprehensive curriculum in physics, chemistry, and related fields. We aim to provide students with a strong foundation in scientific principles and research methodologies.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Our department is actively involved in research projects that contribute to advancements in physical sciences. Students have the opportunity to participate in cutting-edge research and collaborate with faculty members.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                For any queries regarding our Physical Science programs, please contact our department office at <a href="mailto:physicalscience@college.edu" className="text-indigo-600 hover:underline">physicalscience@college.edu</a>.
              </p>
            </motion.div>
          </div>
        </div>
